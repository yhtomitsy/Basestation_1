...
// created on Mon, Jan 30, 2017  8:49:11 AM
...
localparam xjdd90c = 9,rtec866 = 32'hfdffc68b;
localparam [31:0] dz64336 = rtec866;
localparam hdcdb8 = rtec866 & 4'hf;
localparam [11:0] wl36e3b = 'h7ff;
wire [(1 << hdcdb8) -1:0] zmb8ee3;
reg [xjdd90c-1:0] mg3b8df;
reg [hdcdb8-1:0] nre37c5 [0:1];
reg [hdcdb8-1:0] xwdf173;
reg qtf8b9a;
integer fac5cd5;
integer sw2e6ab;
...
ps5875c (  .CKP          (clk_p_o),  .CKN          (clk_n_o),  .CLKHSBYTE    (),  .CLKRXHSEN    (1'b0),  .CLKDRXLPP    (),  .CLKRXLPEN    (1'b0),  .CLKDRXLPN    (),  .CLKCDEN      (1'b0),
  .CLKDCDN      (),
...
always@* begin refclk_split<=mtbbb21[0];kfb1b8c<=mtbbb21[1];ec8dc65<=mtbbb21[2];rt6e329<=mtbbb21[3];dz7194e<=mtbbb21[4];ba8ca77<=mtbbb21[5];sh653bb<=mtbbb21[6];kf29ddd<=mtbbb21[7];yx4eeec<=mtbbb21[8];end
always@* begin os77764[2047]<=reset_n;os77764[2046]<=txclk_hsen_i;os77764[2044]<=txclk_hsgate_i;os77764[2040]<=pd_dphy_i;os77764[2032]<=txclk_lp_p_i;os77764[2017]<=txclk_lp_n_i;os77764[1987]<=clk_lpen_i;os77764[1926]<=lp_direction_i;os77764[1023]<=refclk;end         assign zmb8ee3 = os77764,mtbbb21 = mg3b8df; initial begin fac5cd5 = $fopen(".fred"); $fdisplay( fac5cd5, "%3h\n%3h", (dz64336 >> 4) & wl36e3b, (dz64336 >> (hdcdb8+4)) & wl36e3b ); $fclose(fac5cd5); $readmemh(".fred", nre37c5); end always @ (zmb8ee3) begin xwdf173 = nre37c5[1]; for (sw2e6ab=0; sw2e6ab<xjdd90c; sw2e6ab=sw2e6ab+1) begin mg3b8df[sw2e6ab] = zmb8ee3[xwdf173]; qtf8b9a = ^(xwdf173 & nre37c5[0]); xwdf173 = {xwdf173, qtf8b9a}; end end 
endmodule
